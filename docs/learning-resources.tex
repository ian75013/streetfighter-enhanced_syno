...
JavaScript ES5/ES6, HTML/CSS, basic game loop concepts.
...
\midrule
\endhead
  HTML, CSS, and Javascript for Web Developers & \href{https://www.coursera.org/learn/html-css-javascript-for-web-developers}{\texttt{link}} & Core web skills for browser-based game development. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  JavaScript: Getting Started & \href{https://www.pluralsight.com/courses/javascript-getting-started}{\texttt{link}} & ES6 classes, closures, prototype chain — used throughout the game code. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\textit{No specific A Cloud Guru courses identified.}


\section{GitHub Training Repositories}
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/cocos2d/cocos2d-html5}{\textbf{cocos2d/cocos2d-html5}} — Framework source; scene graph, animation, physics internals.
  \item \href{https://github.com/GDquest/godot-2d-game-creation-course}{\textbf{GDquest/godot-2d-game-creation-course}} — Modern 2D game development patterns (FSM, physics, animation) in a different engine.
\end{itemize}
